...
class MergeEditLine
{
  public:
    ...
    Q_REQUIRED_RESULT QString getString(const std::shared_ptr<QVector<LineData>> &pLineDataA, const std::shared_ptr<QVector<LineData>> &pLineDataB, const std::shared_ptr<QVector<LineData>> &pLineDataC) const;
