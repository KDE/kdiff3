...
void OptionDialog::setupMergePage()
{
    ...
    pWhiteSpace2FileMergeDefault->insertItem(1, u8"A");
    pWhiteSpace2FileMergeDefault->insertItem(2, u8"B");
    label->setToolTip(i18n(
    ...
    pWhiteSpace3FileMergeDefault->insertItem(1, u8"A");
    pWhiteSpace3FileMergeDefault->insertItem(2, u8"B");
    pWhiteSpace3FileMergeDefault->insertItem(3, u8"C");
    label->setToolTip(i18n(
        "Allow the merge algorithm to automatically select an input for "
        "white-space-only changes."));
    ++line;
